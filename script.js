...
var SYM_RU = [
  ...
  {c:"Терморегулятор или утечка", d:"Компрессор не выключается, если терморегулятор не видит холода, уплотнитель пропускает тепло или ушёл фреон. Проверяем все три причины за один визит.", t:"10-20 мин", p:["pt-therm","pt-seal","pt-cond"], l:"терморегулятор · конденсатор", w:[["Замена терморегулятора","после диагностики"],["Поиск и устранение утечки фреона","от 5 000 ₸"],["Заправка фреоном","от 20 000 ₸"]]}
];
