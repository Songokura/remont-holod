...
var SYM_RU = [
  {c:"Утечка фреона, компрессор или нарушение циркуляции воздуха", d:"Чаще всего уходит фреон через микротрещину в контуре, реже - потеря производительности компрессора, забит капилляр или нарушение циркуляции воздуха. Найдём течеискателем и починим на месте.", t:"30-60 мин", p:["pt-evap","pt-comp","pt-cap","pt-fan"], l:"испаритель · компрессор · вентилятор", w:[["Поиск и устранение утечки фреона","от 5 000 ₸"],["Заправка фреоном","от 45 000 ₸"],["Замена компрессора на обычный 220 В","35 000 ₸"],["Вентилятор, капилляр, фильтр-осушитель","после диагностики"]]},
