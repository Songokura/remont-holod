...
var SYM_RU = [
  {c:"Утечка фреона, компрессор или циркуляция воздуха", d:"Чаще всего уходит фреон через микротрещину в контуре, реже - потеря производительности компрессора, забитый капилляр или нарушение циркуляции воздуха. Найдём причину и починим на месте.", t:"30-60 мин", p:["pt-evap","pt-comp","pt-cap","pt-fan"], l:"испаритель · компрессор · вентилятор", w:[["Поиск и устранение утечки фреона","от 5 000 ₸"],["Заправка фреоном","от 20 000 ₸"],["Замена компрессора на обычный 220 В","35 000 ₸"],["Вентилятор, капилляр, фильтр-осушитель","после диагностики"]]},
  {c:"Реле, плата или предохранитель", d:"Холодильник молчит и лампочка не горит? Сначала проверьте розетку: включите в неё любой другой бытовой прибор. Розетка рабочая - смотрим пуско-защитное реле, предохранитель и плату управления. Детали с собой.", t:"10-30 мин", p:["pt-relay","pt-board"], l:"реле · плата", w:[["Замена плавкого предохранителя","от 5 000 ₸"],["Замена пуско-защитного реле","от 10 000 ₸"],["Ремонт платы управления","после диагностики"]]},
  ...
  {c:"Регулятор, фреон или уплотнитель", d:["регулятор температуры установлен на максимум","холодильник не может набрать заданную температуру","нарушена циркуляция холодного воздуха (в системах No Frost)","не хватает хладагента (фреона)","утечка хладагента","дверь неплотно прилегает: уплотнитель изношен или повреждён"], t:"10-30 мин", p:["pt-therm","pt-seal","pt-fan","pt-evap"], l:"терморегулятор · вентилятор · уплотнитель", w:[["Замена терморегулятора","после диагностики"],["Поиск и устранение утечки фреона","от 5 000 ₸"],["Заправка фреоном","от 20 000 ₸"]]}
];
...
function showSym(i){
  ...
  if (d) { d.hidden = isList; d.textContent = isList ? "" : s.d; }
