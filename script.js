...
var SYM_RU = [
  ...
  {c:"Реле, плата или предохранитель", d:"Если холодильник молчит и лампочка не горит, в первую очередь требуется проверить розетку, подключив в неё любой другой бытовой прибор. Если розетка исправна - смотрим пуско-защитное реле, плавкий предохранитель и плату управления. Детали с собой.", t:"10-30 мин", p:["pt-relay","pt-board"], l:"реле · плата", w:[["Замена плавкого предохранителя","от 5 000 ₸"],["Замена пуско-защитного реле","от 10 000 ₸"],["Ремонт платы управления","после диагностики"]]},
