...
var SYM_RU = [
  ...
  {c:"Пуско-защитное реле", d:"Щелчок и тишина каждые несколько минут - реле пытается запустить компрессор и уходит в защиту. Обычно хватает замены реле, реже нужен компрессор.", t:"5-10 мин", p:["pt-relay","pt-comp"], l:"реле · компрессор", w:[]},
